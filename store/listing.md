# Chrome Web Store listing â€“ SidePrompt

Copy/paste these into the Developer Dashboard. Keep the keyword-rich title; store search is the only distribution channel.

## Name (max 75 chars)
SidePrompt â€“ AI Prompt Manager for ChatGPT, Claude & Gemini

## Summary (max 132 chars)
Save, organize and insert your best AI prompts in one click. Folders, tags, {{variables}}, search. ChatGPT, Claude, Gemini & more.

## Category
Productivity â†’ Tools (or "Workflow & Planning")

## Language
English

## Detailed description
Stop retyping the same prompts. SidePrompt keeps your best AI prompts in a side panel next to ChatGPT, Claude, Gemini, Copilot, Perplexity and other AI chats â€“ and inserts them into the chat box with one click.

âšˇ ONE-CLICK INSERT
...
đź”’ PRIVATE BY DESIGN
Your prompts are stored locally in your browser. Nothing is sent to our servers â€“ there are none. No account required.

đźŽ FREE
15 prompts, 5 folders, variables, search, export â€“ free forever.

â­ PRO (one-time payment, no subscription)
â€˘ Unlimited prompts and folders
â€˘ Sync across all your Chrome browsers (via your Google account)
â€˘ Import prompts from JSON
Pay once, keep it forever.

KEYBOARD SHORTCUTS
Alt+P opens the side panel Â· / focuses search Â· N creates a new prompt Â· Ctrl+Enter saves.
...
## Screenshots (1280x800) â€“ generated by `npm run screenshots` into store/assets/
